# PHP 8.5 (PHP-FPM) on alpine Linux
...
* Forked from [official PHP-FPM build with alpine Linux](https://store.docker.com/images/php) (php:8.5-fpm-alpine).
